                            ...
                            child: ListTile(
                              onTap: (){
                                Navigator.push(context,MaterialPageRoute(builder: (context)=>
                                    TeacherProfilePersonScreen(i: index,image: mydata.image,name: mydata.name,age: mydata.age,section: mydata.section,studentclass: mydata.studentclass,subjects: mydata.subjects,)));
                              },
